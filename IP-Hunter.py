...
def show_help():
    ...
    print(f"  • {Language.get('help_candidate')}")
    print(f"  • {Language.get('help_confidence')}")
    
    print(f"\n{Colors.BOLD}{Language.get('help_tips')}{Colors.END}")
    print(f"  • {Language.get('help_verify')}")
    print(f"  • {Language.get('help_multi')}")
    print(f"  • {Language.get('help_legal')}")
